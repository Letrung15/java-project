...
import com.vuongletrung.exercise03.repository.ProductRepository;
import com.vuongletrung.exercise03.service.ProductService;
...
public class ProductServiceImpl implements ProductService {
    ...
    public List<Product> getProductsByTagId(String tagId) {
        return productRepository.findProductsByTagIdOrderByCreatedAtAndUpdatedAtDesc(tagId);
    }
