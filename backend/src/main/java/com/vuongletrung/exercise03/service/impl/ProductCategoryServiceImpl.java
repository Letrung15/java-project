...
import com.vuongletrung.exercise03.repository.ProductCategoryRepository;
...
public class ProductCategoryServiceImpl implements ProductCategoryService {
    ...
    @Override
    public void deleteProductCategoriesByProductIdAndCategoryId(String productId, String categoryId) {
        List<ProductCategory> productCategories = productCategoryRepository
                .findByProductProductIdAndCategoryCategoryId(productId, categoryId);
        productCategoryRepository.deleteAll(productCategories);
    }
