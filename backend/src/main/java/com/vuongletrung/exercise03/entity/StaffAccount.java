package com.vuongletrung.exercise03.entity;
...
@NoArgsConstructor
@AllArgsConstructor
@JsonIgnoreProperties({ "productsCreate", "galleriesCreate", "tagsCreate", "categoriesCreate", "productsUpdate",
        "galleriesUpdate", "tagsUpdate", "categoriesUpdate" })
@Entity
