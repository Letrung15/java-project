                    ...
                    <Paper className={classes.paper}>
                        ...
                        <Grid item xs={12} sm container>
                            ...
                            <Grid item xs={12}>
                                ...
                                <TextField id="ImagePath" onChange={handleChangeImagePath} name="ImagePath" label="ImagePath"
                                    variant="outlined" className={classes.txtInput} size="small" />
                            </Grid>
                            <Grid item xs={12}>
                                <Typography gutterBottom variant="subtitle1">
                                ...
                                <TextField id="PlaceHolder" onChange={handleChangePlaceholder} name="PlaceHolder" label="PlaceHolder"
                                    variant="outlined" className={classes.txtInput} size="small" />
                            </Grid>
